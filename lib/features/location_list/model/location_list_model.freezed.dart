...
mixin _$RickMortyLocationListData {
 ...
 List<RickMortyLocationListResult> get results;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is RickMortyLocationListData&&const DeepCollectionEquality().equals(other.results, results));
}
...
@override
String toString() {
  return 'RickMortyLocationListData(results: $results)';
}
...
@useResult
$Res call({
 List<RickMortyLocationListResult> results
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( List<RickMortyLocationListResult> results)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _RickMortyLocationListData() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( List<RickMortyLocationListResult> results)  $default,) {final _that = this;
switch (_that) {
case _RickMortyLocationListData():
return $default(_that.results);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( List<RickMortyLocationListResult> results)?  $default,) {final _that = this;
switch (_that) {
case _RickMortyLocationListData() when $default != null:
return $default(_that.results);case _:
  return null;
...
class _RickMortyLocationListData implements RickMortyLocationListData {
   _RickMortyLocationListData({required final  List<RickMortyLocationListResult> results}): _results = results;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _RickMortyLocationListData&&const DeepCollectionEquality().equals(other._results, _results));
}
